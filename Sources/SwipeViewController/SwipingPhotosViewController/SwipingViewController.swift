...
public protocol SwipingViewControllerDataSource: AnyObject {
  func swipingPhotosControllerAllViewControllers(_ swipingPhotosController: SwipingViewController) -> [UIViewController]
}

public class SwipingViewController: UIViewController {
  
  weak public var dataSource: SwipingViewControllerDataSource?
...
extension SwipingViewController {
  ...
  fileprivate func makeBarStackView() -> UIStackView {
    ...
    let countOfControllers = dataSource.swipingPhotosControllerAllViewControllers(self).count
  ...
  fileprivate func makeAllControllers() -> [UIViewController] {
    ...
    return dataSource.swipingPhotosControllerAllViewControllers(self)
  }
...
extension SwipingViewController: UIPageViewControllerDataSource {
...
extension SwipingViewController: UIPageViewControllerDelegate {
